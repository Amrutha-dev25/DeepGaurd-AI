...
export const STATIC_SAMPLES: SampleMedia[] = [
  {
    ...
    findings: [
      ...
      'Specular skin reflection vectors remain at 34 deg despite real studio keylight moving on the left',
    ...
    overlays: [
      ...
      },
      {
        ...
        description: 'Skin luminance registers a static 34 deg light angle. Studio lighting is positioned at 12 deg.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    overlays: [
      ...
      },
      {
        ...
        description: 'Calculated nose shadow suggests light from 45 deg left. Body/collar shadows fall forward.'
      }
    ]
  }
];
